...
public class RegistrationHandler
{
    ...
    public static final ItemStack   dirtPlate                = new ItemStack(
                                                                     plate, 1,
                                                                     5);
    ...
    public static final ItemStack   enderPlate               = new ItemStack(
                                                                     plate, 1,
                                                                     4);
    ...
    public static final Item        flameArmorLegs           = new FlameArmor(2)
                                                                     ...
                                                                     .setTextureName(
                                                                             "core_moarmor:flame_helmet");
    public static final ItemStack   flamePlate               = new ItemStack(
                                                                     plate, 1,
                                                                     3);
    ...
    public static final ItemStack   flintPlate               = new ItemStack(
                                                                     plate, 1,
                                                                     0);
    
    private static final Item       obsidianArmorBoots       = new ObsidianArmor(
                                                                     3)
                                                                     .setUnlocalizedName(
                                                                             "obsidianArmorBoots")
                                                                     .setTextureName(
    ...
    private static final Item       obsidianArmorChest       = new ObsidianArmor(
                                                                     1)
                                                                     .setUnlocalizedName(
                                                                             "obsidianArmorChest")
                                                                     .setTextureName(
                                                                             "core_moarmor:obsidian_chestplate");
    private static final Item       obsidianArmorHelmet      = new ObsidianArmor(
                                                                     0)
                                                                     .setUnlocalizedName(
                                                                             "obsidianArmorHelmet")
                                                                     .setTextureName(
                                                                             "core_moarmor:obsidian_helmet");
    private static final Item       obsidianArmorLegs        = new ObsidianArmor(
                                                                     2)
                                                                     .setUnlocalizedName(
                                                                             "obsidianArmorLegs")
                                                                     .setTextureName(
                                                                             "core_moarmor:obsidian_leggings");
    public static final ItemStack   obsidianPlate            = new ItemStack(
                                                                     plate, 1,
                                                                     2);
    
    private static final Item       quartzArmorBoots         = new QuartzArmor(
                                                                     3)
                                                                     .setUnlocalizedName(
                                                                             "quartzArmorBoots")
                                                                     .setTextureName(
                                                                             "core_moarmor:netherquartz_boots");
    private static final Item       quartzArmorChest         = new QuartzArmor(
                                                                     1)
                                                                     .setUnlocalizedName(
                                                                             "quartzArmorChest")
                                                                     .setTextureName(
                                                                             "core_moarmor:netherquartz_chestplate");
    private static final Item       quartzArmorHelmet        = new QuartzArmor(
                                                                     0)
                                                                     .setUnlocalizedName(
                                                                             "quartzArmorHelmet")
                                                                     .setTextureName(
                                                                             "core_moarmor:netherquartz_helmet");
    private static final Item       quartzArmorLegs          = new QuartzArmor(
                                                                     2)
                                                                     .setUnlocalizedName(
                                                                             "quartzArmorLegs")
                                                                     .setTextureName(
                                                                             "core_moarmor:netherquartz_leggings");
    public static final ItemStack   quartzPlate              = new ItemStack(
                                                                     plate, 1,
                                                                     1);
    ...
    public static final Item        foodArmorHelmetPorkchop  = new FoodArmor(0,
                                                                     "Automatically restores 4 hungerbars when hungry")
                                                                     .setUnlocalizedName(
                                                                             "foodArmorHelmetPork")
                                                                     .setTextureName(
                                                                             "core_moarmor:food_helmet");
    public static final Item        foodArmorHelmetCookie    = new FoodArmor(0,
                                                                     "Automatically restores 1 hungerbar when hungry")
                                                                     .setUnlocalizedName(
                                                                             "foodArmorHelmetCookie")
                                                                     .setTextureName(
                                                                             "core_moarmor:food_helmet");
    public static final Item        foodArmorHelmetBread     = new FoodArmor(0,
                                                                     "Automatically restores 2 and a half hungerbar when hungry")
                                                                     .setUnlocalizedName(
                                                                             "foodArmorHelmetBread")
                                                                     .setTextureName(
                                                                             "core_moarmor:food_helmet");
    public static final Item        foodArmorHelmetApple     = new FoodArmor(0,
                                                                     "Automatically restores 2 hungerbars when hungry")
                                                                     .setUnlocalizedName(
    ...
    public static final Item        netherArmorBoots         = new NetherArmor(
                                                                     3)
                                                                     .setUnlocalizedName(
                                                                             "netherArmorBoots")
                                                                     .setTextureName(
                                                                             "core_moarmor:netherbrick_boots");
    public static final Item        netherArmorChest         = new NetherArmor(
                                                                     1)
                                                                     .setUnlocalizedName(
                                                                             "netherArmorChest")
                                                                     .setTextureName(
                                                                             "core_moarmor:netherbrick_chestplate");
    public static final Item        netherArmorHelmet        = new NetherArmor(
                                                                     0)
                                                                     .setUnlocalizedName(
                                                                             "netherArmorHelmet")
                                                                     .setTextureName(
                                                                             "core_moarmor:netherbrick_helmet");
    public static final Item        netherArmorLegs          = new NetherArmor(
                                                                     2)
                                                                     .setUnlocalizedName(
                                                                             "netherArmorLegs")
                                                                     .setTextureName(
    ...
    public static final Achievement diamondHammerAchievement = new Achievement(
                                                                     "achievement.diamondHammerCrafted",
                                                                     "diamondHammerCrafted",
                                                                     -2,
                                                                     3,
                                                                     diamondHammer,
                                                                     AchievementList.diamonds);
    public static final Achievement suicideAchievement       = new Achievement(
                                                                     "achievement.suicideBomber",
                                                                     "suicideBomber",
                                                                     2,
                                                                     7,
                                                                     Blocks.tnt,
                                                                     hammerAchievement)
                                                                     .setSpecial();
    public static final Achievement ecoAchievement           = new Achievement(
                                                                     "achievement.ecoFriendly",
                                                                     "ecoFriendly",
                                                                     0,
                                                                     7,
                                                                     grassArmorChest,
                                                                     hammerAchievement);
    public static final Achievement betterAchievement        = new Achievement(
                                                                     "achievement.betterDiamond",
                                                                     "betterDiamond",
                                                                     -2,
                                                                     1,
                                                                     obsidianArmorChest,
                                                                     diamondHammerAchievement);
    ...
    public static void registerArmorRecipes()
    {
        ...
        GameRegistry.addRecipe(new ItemStack(flintArmorLegs, 1), "FFF", "F F",
                "F F", 'F', flintPlate);
        GameRegistry.addRecipe(new ItemStack(flintArmorBoots, 1), "F F", "F F",
                'F', flintPlate);
        ...
        GameRegistry.addRecipe(new ItemStack(quartzArmorLegs, 1), "QQQ", "Q Q",
                "Q Q", 'Q', quartzPlate);
        GameRegistry.addRecipe(new ItemStack(quartzArmorBoots, 1), "Q Q",
                "Q Q", 'Q', quartzPlate);
        ...
        GameRegistry.addRecipe(new ItemStack(flameArmorLegs, 1), "OOO", "O O",
                "O O", 'O', flamePlate);
        GameRegistry.addRecipe(new ItemStack(flameArmorBoots, 1), "O O", "O O",
                'O', flamePlate);
        ...
        GameRegistry.addRecipe(new ItemStack(tntArmorLegs, 1), "OOO", "O O",
                "O O", 'O', tntPlate);
        GameRegistry.addRecipe(new ItemStack(tntArmorBoots, 1), "O O", "O O",
                'O', tntPlate);
        ...
        GameRegistry.addRecipe(new ItemStack(grassArmorLegs, 1), "OOO", "O O",
                "O O", 'O', grassPlate);
        GameRegistry.addRecipe(new ItemStack(grassArmorBoots, 1), "O O", "O O",
                'O', grassPlate);
        ...
        GameRegistry.addRecipe(new ItemStack(dirtArmorLegs, 1), "OOO", "O O",
                "O O", 'O', dirtPlate);
        GameRegistry.addRecipe(new ItemStack(dirtArmorBoots, 1), "O O", "O O",
                'O', dirtPlate);
        
        GameRegistry.addRecipe(new ItemStack(netherArmorHelmet, 1), "OOO",
                "O O", 'O', netherPlate);
        GameRegistry.addRecipe(new ItemStack(netherArmorChest, 1), "O O",
        ...
        GameRegistry.addRecipe(new ItemStack(woodArmorHelmet, 1), "OOO", "O O",
                'O', woodPlate);
        GameRegistry.addRecipe(new ItemStack(woodArmorChest, 1), "O O", "OOO",
                "OOO", 'O', woodPlate);
        GameRegistry.addRecipe(new ItemStack(woodArmorLegs, 1), "OOO", "O O",
                "O O", 'O', woodPlate);
        GameRegistry.addRecipe(new ItemStack(woodArmorBoots, 1), "O O", "O O",
                'O', woodPlate);
    }
    ...
    {
        GameRegistry.registerItem(foodArmorHelmetPorkchop,
                foodArmorHelmetPorkchop.getUnlocalizedName());
        GameRegistry.registerItem(foodArmorHelmetCookie,
                foodArmorHelmetCookie.getUnlocalizedName());
        GameRegistry.registerItem(foodArmorHelmetBread,
                foodArmorHelmetBread.getUnlocalizedName());
        GameRegistry.registerItem(foodArmorHelmetApple,
                foodArmorHelmetApple.getUnlocalizedName());
        GameRegistry.registerItem(foodArmorChest,
                foodArmorChest.getUnlocalizedName());
        GameRegistry.registerItem(foodArmorLegs,
                foodArmorLegs.getUnlocalizedName());
        GameRegistry.registerItem(foodArmorBoots,
                foodArmorBoots.getUnlocalizedName());
        ...
        GameRegistry
                .addRecipe(breadArmorHelmet, "OOO", "O O", 'O', Items.bread);
        
        ArmorHelper.addStringToNBT(appleArmorHelmet, "feedlevel", "4");
        GameRegistry
                .addRecipe(appleArmorHelmet, "OOO", "O O", 'O', Items.apple);
        ...
        GameRegistry.addRecipe(new ItemStack(foodArmorBoots, 1), "O O", "O O",
                'O', Items.cooked_porkchop);
